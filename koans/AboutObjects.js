describe("About Objects", function() {
    ...
    var meglomaniac = { 
      ...
      battleCry: function(noOfBrains) {
        return "They are " + this.henchman + " and the" +
          ...
          //This is such weird code.
          //Blank array with 5 elements, joined together with a delimeter of " Brain"
          //There are 4 delimeters for 5 elements.
      }
    };
  ...
  describe("'in' keyword", function() {
    ...
    it("should have the bomb", function() {
      ...
      //Don't be tricked! It is not tru because theBomb: true, but because theBomb is defined.
